require('script!../../../node_modules/canvasengine/canvasengine-1.3.2.all.min.js');

const createGameover = require('./scene/Scene_Gameover');
const createGenerated = require('./scene/Scene_Generated');
const createLoad = require('./scene/Scene_Load');
const createMap = require('./scene/Scene_Map');
const createMenu = require('./scene/Scene_Menu');
const createTitle = require('./scene/Scene_Title');
const createWindow = require('./scene/Scene_Window');
const Game_Actor = require('./game/Game_Actor');
const Game_Character = require('./game/Game_Character');
const Game_CommonEvents = require('./game/Game_CommonEvents');
const Game_Event = require('./game/Game_Event');
const Game_Map = require('./game/Game_Map');
const Game_Player = require('./game/Game_Player');
const Game_Plugin = require('./game/Game_Plugin');
const Game_Save = require('./game/Game_Save');
const Game_SelfSwitches = require('./game/Game_SelfSwitches');
const Game_Switches = require('./game/Game_Switches');
const Game_System = require('./game/Game_System');
const Game_Variables = require('./game/Game_Variables');
const Interpreter = require('./game/Interpreter');
const Sprite = require('./sprite/Sprite');
const Sprite_Character = require('./sprite/Sprite_Character');
const Sprite_Plugin = require('./sprite/Sprite_Plugin');
const Spriteset_Map = require('./sprite/Spriteset_Map');
const GRAPHICS_PATH = '/wicket/resource/com.appdirect.wicket.resources.Resource/spa/themes/base/ipa/rpg-home/graphics/';
...
*/
	ready: function(callback) {
		...
		RPGJS_Canvas = window.RPGJS_Canvas = CE.defines(this.params.canvas, this.params).
			extend(extend).
			ready(function() {
...
*/
		...
		load: function(onFinish, abs_path) {
			createMap();
			createWindow();
			createTitle();
			createMenu();
...
*/
	Path: {
		...
		tilesets: GRAPHICS_PATH + "Tilesets/",
		windowskins: GRAPHICS_PATH + "Windowskins/",
		autotiles: GRAPHICS_PATH + "Autotiles/",
		characters: GRAPHICS_PATH + "Characters/",
		animations: GRAPHICS_PATH + "Animations/",
		pictures: GRAPHICS_PATH + "Pictures/",
		battlers: GRAPHICS_PATH + "Battlers/",
		icons: GRAPHICS_PATH + "Icons/",
		tiles: GRAPHICS_PATH + "Tiles/",
		faces: GRAPHICS_PATH + "Faces/",
		fonts: GRAPHICS_PATH + "fonts/",
		gameovers: GRAPHICS_PATH + "Gameovers/",
		bgms: "Audio/BGM/",
		bgss: "Audio/BGS/",
		mes: "Audio/ME/",
		ses: "Audio/SE/",
...
var RPGJS = window.RPGJS = Class.New("RPGJS"), RPGJS_Canvas,  RPGJS_Scene, global = window;
